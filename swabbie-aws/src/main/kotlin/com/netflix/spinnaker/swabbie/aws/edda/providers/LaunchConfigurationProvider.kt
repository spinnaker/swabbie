...
class LaunchConfigurationProvider(
  private val aws: AWS
) : ResourceProvider<AmazonLaunchConfiguration>, AWS by aws {
  override fun getAll(params: Parameters): List<AmazonLaunchConfiguration>? {
    return getLaunchConfigurations(params)
  }

  override fun getOne(params: Parameters): AmazonLaunchConfiguration? {
    return getLaunchConfiguration(params)
  }
}
